...
public class Library {
    ...
    public boolean IsBorrowerPresent(int id)
        {
     ...
     public boolean IsClerkPresent(int id)
     {
     ...
     public boolean IsLibrarianPresent(int id)
     {
     ...
     public String CheckLoanofUser(int user_id, int clerk_id)
     {
        String Str="";
       for(int i=0; i< ClerkList.size() ; i++)
       {
     ...
     public ArrayList <Books>ClerkSearchBookbyAuthor(String author, int clerk_id)
     {
         ArrayList <Books> SelectedBooks = new ArrayList <>();
     ...
     public ArrayList <Books>ClerkSearchBookbySubject(String subject, int clerk_id)
     {
         ArrayList <Books> SelectedBooks = new ArrayList <>();
    ...
    public boolean  AddNewBorrower(String borrower_name, char gender, String tel_num, String address, int clerk_id)
    {
    ...
    public Boolean ClerkUpdatingInfo(String Info, int choice, int clerk_id, int user_id)
    {
    ...
    public void ClerkRecordFine(int user_id, int clerk_id)
    {
     ...
     public void ClerkCheckInItem(String ret_date, int book_id, int borrower_id, int clerk_id) {
      ...
      public void ClerkCheckOutItem(int book_id, int borrower_id, int clerk_id) {
    ...
    public void ClerkRenewItem(int book_id, int option, int clerk_id)
    {
